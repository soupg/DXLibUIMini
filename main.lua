...
function Lib:CreateWindow( index )
    ...
    function Win:AddTab( TabName )
        ...
        if Lib.Active and Win.Tabs[TabName].Name == TabName then
            if Win.TabMargin + TabLength + 3 < 270 then
        ...
        function Tab:AddGroupbox(name)
            ...
            --// Display Groupbox
            if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Tab.leftstack + Groupbox.Vertical + 10 < 600 then
            ...
            function Groupbox:AddButton( btn_name , func )
                ...
                if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Groupbox.Visible then
                    ...
                    if Groupbox.Root[2] + 22 + ((18 + Groupbox.ToolSpacing) * n) < Win.Location[2] + Win.Size[2] - 24 then --// Y Limit for groupbox size ting bruv
            ...
            function Groupbox:AddColorPicker( index , params ) 
                ...
                if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Groupbox.Visible and (Groupbox.Root[2] + 38 + Groupbox.ToolSpacing) < Win.Location[2] + Win.Size[2] - 24 then --// Y Limit for groupbox size ting bruv
            ...
            function Groupbox:AddTitle(text)
                ...
                if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Groupbox.Visible and (Groupbox.Root[2] + 42 + Groupbox.ToolSpacing) < Win.Location[2] + Win.Size[2] - 24 then
            ...
            function Groupbox:AddBlank(size)
                ...
                if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Groupbox.Visible and (Groupbox.Root[2] + size + Groupbox.ToolSpacing) < Win.Location[2] + Win.Size[2] - 24 then
            ...
            function Groupbox:AddLabel(text)
                ...
                if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Groupbox.Visible then
                    ...
                    if (Groupbox.ToolSpacing + (7 + (18 * n)) + Groupbox.Root[2]) < Win.Location[2] + Win.Size[2] - 24 then
                        Groupbox.Vertical = Groupbox.Vertical + (7 + (18 * n))
            ...
            function Groupbox:AddToggle( index , params ) 
                ...
                if Win.CurrentTab ~= nil and Win.CurrentTab == Tab.Name and Lib.Active and Groupbox.Visible and (Groupbox.Root[2] + 38 + Groupbox.ToolSpacing) < Win.Location[2] + Win.Size[2] - 24 then
                    Groupbox.Vertical = Groupbox.Vertical + 25
